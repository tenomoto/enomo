...
SRC = type_module.f90 math_module.f90 earth_module.f90 air_module.f90 water_module.f90 \
      ...
      confmap_module.f90 regrid_module.f90 closestindex_module.f90
OBJ = ${SRC:%.f90=%.o}
MOD = ${SRC:%.f90=%.mod}
...
sphere_module.o : type_module.o math_module.o glatwgt_module.o closestindex_module.o
...
closestindex_module.o : type_module.o
